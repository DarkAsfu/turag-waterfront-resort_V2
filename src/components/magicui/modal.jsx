...
export function MediaModal({ imgSrc, videoSrc, className, alt }) {
        ...
        <AnimatePresence initial={false} mode="sync">
          {isMediaModalOpen && (
            <>
              ...
              >
                <motion.div
                  className="pointer-events-auto relative flex flex-col overflow-hidden   dark:bg-gray-950 bg-gray-200 border w-[95%] md:max-w-7xl h-[70%] md:h-[90%] "
                  layoutId={`dialog-${uniqueId}`}
                  tabIndex={-1}
                  style={{
                    borderRadius: '24px',
